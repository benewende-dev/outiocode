...
import { OUTIO_DEFAULTS, OUTIO_DEFAULT_MODEL } from "./outio-defaults"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const loadGlobal = Effect.fnUntraced(function* (env?: Record<string, string>) {
      // OutioCode: seed the baked-in Outio provider as the default. Merged
      // first so user config (opencode.json / outio.json) still overrides it.
      let result: Info = mergeConfig({ model: OUTIO_DEFAULT_MODEL } as Info, OUTIO_DEFAULTS as unknown as Info)
