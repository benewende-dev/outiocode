...
export const UninstallCommand = {
  command: "uninstall",
  describe: "uninstall OutioCode and remove all related files",
  builder: (yargs: Argv) =>
    yargs
      .option("keep-config", {
        alias: "c",
...
async function showRemovalSummary(targets: RemovalTargets, method: Installation.Method) {
  ...
  if (method !== "curl" && method !== "unknown") {
    const cmds: Record<string, string> = {
      npm: "npm uninstall -g outio",
      pnpm: "pnpm uninstall -g outio",
      bun: "bun remove -g outio",
      yarn: "yarn global remove outio",
      brew: "brew uninstall outio",
      choco: "choco uninstall outio",
      scoop: "scoop uninstall outio",
    }
